...
const CONTENT = {
  ja: {
    ...
    paragraphs: [
      ...
      "自律と暴走は紙一重です。だからこそ、力を増やすことと同じだけ、人が安心して任せられる仕組みづくりに時間をかけます。",
      "そして、自分の仕事をダン自身に任せながら、毎日ダンを鍛えています。実際の現場で使い、つまずき、直す。現実から逆算することでしか、驚きのある体験は作れません。",
      "エージェント開発は始まったばかり、黎明期です。",
      "ひとつずつ、確かに。魔法のようなAIエージェントを目指します。",
    ],
    signature: "株式会社パイナ",
  },
  en: {
    ...
    paragraphs: [
      ...
      "Autonomy and recklessness are a hair apart. So just as much care goes into raising its capability as into building the safeguards that let people delegate with confidence.",
      "And Done is sharpened every day by being trusted with real work. Used in the field, it stumbles, and it gets fixed. Only by working backward from reality can we create experiences that genuinely surprise.",
      "Agent development has only just begun — these are its earliest days.",
      "One at a time, with certainty. Aiming for an AI agent that feels like magic.",
    ],
    signature: "PAINA Inc.",
  },
};
