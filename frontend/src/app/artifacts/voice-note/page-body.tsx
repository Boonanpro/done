...
export function PageBody() {
 ...
 <div className={styles.editorTop}><h2>記事の仕上がり</h2><div className={styles.actions}>{mediaUndo&&<button type="button" aria-label="変更を取り消す" title="変更を取り消す" onClick={()=>{update(mediaUndo);setMediaUndo(null);}}><Undo2 size={17}/></button>}</div></div>
