...
export function PageBody() {
 ...
 {draft.editorialNotes&&<details className={styles.notice}><summary>編集メモ・画像の挿入計画（投稿本文には含みません）</summary><ReactMarkdown>{draft.editorialNotes}</ReactMarkdown></details>}
