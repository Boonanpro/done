...
export function PageBody() {
 ...
 <EditableText as="button" editId="voice-note-regenerate-title" disabled={busy||editing||recording||Boolean(audioBlob)||!draft.title.trim()||(!draft.transcript.trim()&&!draft.audio.length)} onClick={()=>void send('edit','title')}>このタイトルで本文を作り直す</EditableText><small style={{display:'block',marginTop:8}}>前の原稿は履歴に残ります。導入から結末までタイトルに合わせて整えます。</small>
