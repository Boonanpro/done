...
export type Article = {
 xDraft?: {post:string;articleTitle:string;articleBody:string;reply:string;postUrl:string;instruction:string;generatedAt?:number};
 editorLayout?: {free:string;paid:string;html:string};
