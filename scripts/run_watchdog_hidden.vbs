' DanFrontendWatchdog 用の非表示ランチャー。
...
WScript.Quit CreateObject("WScript.Shell").Run("powershell.exe -NoProfile -ExecutionPolicy Bypass -File ""D:\done\scripts\ensure_frontend_3000.ps1""", 0, True)
